...
para mostrar y ocultar funcionalidades.

## Administrativo

Como administrativo,  
quiero agendar citas, modificarlas y eliminarlas,  
para organizar la agenda de los coaches.
...
para que el coachee pueda completarlos para la próxima sesión.

Como coach,  
quiero poder acceder a pildoras informativas durante la sesión,  
para poder explicárselas al coachee.
...
para hacer la sesión más dinámica.

Como coach,  
quiero poder enviar herramientas y test al coachee en sesión online,  
para ver como los completa en tiempo real.

Como coach,  
quiero que los test y las herramientas se corrijan automáticamente,  
para acelerar la gestión durante la sesión.
...
para aumentar la creatividad para próximas sesiones.

Como coach,  
quiero que una IA interprete los resultados de herramientas y test y aporte sugerencias,  
para incrementar la cantidad de ideas de continuación del proceso.
